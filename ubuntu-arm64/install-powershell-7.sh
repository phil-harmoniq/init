...
sudo mkdir -p /usr/share/powershell/7.2

# Expand powershell to the target folder
sudo tar zxf /tmp/powershell.tar.gz -C /usr/share/powershell/7.2

# Set execute permissions
sudo chmod +x /usr/share/powershell/7.2/pwsh

# Create the symbolic link that points to pwsh
sudo ln -sf /usr/share/powershell/7.2/pwsh /usr/bin/pwsh
